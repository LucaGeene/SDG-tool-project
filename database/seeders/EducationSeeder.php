...
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Begeleiden bij Rouw en Verlies'
//        ]);
        DB::table('education')->insert([
            'name' => 'Bouwkunde',
...
//        DB::table('education')->insert([
//            'name' => 'Engineering Associate degree'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Food & Gastronomy Associate degree [NIEUW]'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Health & Social Work Associate degree'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Health & Social Work Associate degree [NIEUW]'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Het nieuwe leiderschap'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Human Resource Management Associate degree'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Hybride Zorgopleider'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Informatica Associate degree'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Logistiek Associate degree'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Management Associate degree'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Pedagogisch Professional Kind en Educatie Associate degree'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'River Delta Development (MSc)'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Schakelcursus Economie'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Schakelcursus Natuurkunde'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Schakelcursus Wiskunde'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Seksualiteit en seksueel misbruik'
//        ]);
        DB::table('education')->insert([
            'name' => 'Social Work',
...
//        DB::table('education')->insert([
//            'name' => 'Summer School Delta Challenges'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Technische Bedrijfskunde Associate degree'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Tourism Management Associate degree'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Vakspecialist Muziek'
//        ]);
//        DB::table('education')->insert([
//            'name' => 'Veiligheidscursussen maritieme sector'
//        ]);
        DB::table('education')->insert([
...
//        DB::table('education')->insert([
//            'name' => 'Water Cycle: concepts, practice and applications'
//        ]);
        DB::table('education')->insert([
