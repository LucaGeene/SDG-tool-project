...
if($this->app->environment('production')) {
    $db_connection = pg_connect(
        ...
        user=lmwebnfnbkddnm
        password=cf231efb04619fbced5ec559a67ba43d5a3f0a53bbc7c81a9bb5a2f08a4f7c1f");
    $result = pg_query($db_connection, "select COUNT(goalid) as projectsum from projects where verified::int = 1 group by goalid");
    $data = array();
